...
using Acme.BookStore.Blazor.WebApp.Tiered.Client;
using Acme.BookStore.Blazor.WebApp.Tiered.Client.Menus;
using Acme.BookStore.Blazor.WebApp.Tiered.Components;
using Acme.BookStore.Blazor.WebApp.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Acme.BookStore.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
