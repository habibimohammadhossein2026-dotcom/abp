...
using Acme.BookStore.Blazor.WebApp.Client;
using Acme.BookStore.Blazor.WebApp.Client.Menus;
using Acme.BookStore.Blazor.WebApp.Components;
...
namespace Acme.BookStore.Blazor.WebApp;
...
public class BookStoreBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "fb0b498f-fccb-4f51-be8b-b958be7c8837");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Acme.BookStore.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
