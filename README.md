...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fb0b498f-fccb-4f51-be8b-b958be7c8837
```

> `fb0b498f-fccb-4f51-be8b-b958be7c8837` is the password of the certificate, you can change it to any password you want.
